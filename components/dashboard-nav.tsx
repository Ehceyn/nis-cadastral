...
import { MapPin, FileText, Users, Settings, LogOut, Menu, X } from "lucide-react"
...
export function DashboardNav({ user }: DashboardNavProps) {
  ...
  const navigation = [
    ...
    { name: "Pillar Search", href: "/search", icon: MapPin },
  ]

  if (user.role === "NIS_OFFICER") {
    navigation.push({ name: "Review Queue", href: "/dashboard/review", icon: Users })
  }
